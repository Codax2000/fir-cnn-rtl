...
module zyNet_matlab_tb ();
    ...
    initial begin
        ...
        measured_outputs = $fopen("C:/Users/alexk/Documents/Projects/fir-cnn-rtl/Scripts/data/test_outputs_actual.csv", "w");
        errors = $fopen("C:/Users/alexk/Documents/Projects/fir-cnn-rtl/Scripts/data/test_outputs_errors.csv", "w");
        reset_i <= 1'b1;
        start_i <= 1'b0;
