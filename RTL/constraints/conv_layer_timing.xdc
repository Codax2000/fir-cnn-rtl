...
set_output_delay -clock [get_clocks clk] -max 4.000 [get_ports {valid_o yumi_o conv_ready_o}]
set_output_delay -clock [get_clocks clk] -min 0.000  [get_ports {valid_o yumi_o conv_ready_o}]